        ...
        >
          ...
          <div className="mt-10 flex flex-wrap gap-5 justify-center">
            ...
            <motion.button
              ...
              whileHover={{ scale: 1.05 }}
              whileTap={{ scale: 0.95 }}
              onClick={() => window.open("https://www.linkedin.com/in/rozal-kenneth-59a3992a7/", "_blank")}
            >
            ...
            <motion.button
              ...
              whileHover={{ scale: 1.05 }}
              whileTap={{ scale: 0.95 }}
              onClick={() => window.open("https://github.com/Tempestrium", "_blank")}
            >
        ...
        >
          ...
          >
            <motion.li className="flex items-start" variants={fadeIn("up", "spring", 0.2, 0.75)}>
              ...
              <span>
                Currently studying for Computer Engineering at Don Honorio Ventura State University, I'm all about building reliable, scalable software that makes a difference.
              </span>
            </motion.li>
            <motion.li className="flex items-start" variants={fadeIn("up", "spring", 0.3, 0.75)}>
              <span className="mr-4 text-2xl flex-shrink-0">🛠</span>
              <span>
                Studying machine learning for projects that streamline operations and deliver real impact.
              </span>
            </motion.li>
