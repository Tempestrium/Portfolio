  ...
  const handleSubmit = (e) => {
    ...
    emailjs
      .send(
        ...
        {
          from_name: form.name,
          to_name: "Kenneth Rozal",
          from_email: form.email,
          to_email: "kennethrozal20@gmail.com@gmail.com",
  ...
  return (
    <div className={`xl:mt-12 flex xl:flex-row flex-col-reverse gap-10 overflow-hidden no-select`}>
      ...
      >
        ...
        >
          ...
          <label className='flex flex-col'>
            ...
            <textarea
              ...
              value={form.message}
              onChange={handleChange}
              placeholder="Hey Kenneth, love the website! I'd like to chat about some opportunities you might like! 🎉"
              className='bg-tertiary py-4 px-6 placeholder:text-secondary text-white rounded-lg outline-none border-none font-medium transition-all duration-300 focus:ring-2 focus:ring-purple-500'
            />
          </label>
        ...
        >
          Copyright &copy; {new Date().getFullYear()} Kenneth Rozal's Portfolio
          <br />
          Designed and Developed by
          <a
            href="https://www.linkedin.com/in/rozal-kenneth-59a3992a7/"
            target="_blank"
